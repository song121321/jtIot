...
package song.jtslkj.tool.htmlspanner;
...
import song.jtslkj.tool.htmlspanner.exception.ParsingCancelledException;
import song.jtslkj.tool.htmlspanner.handlers.*;
import song.jtslkj.tool.htmlspanner.handlers.attributes.AlignmentAttributeHandler;

import song.jtslkj.tool.htmlspanner.handlers.attributes.BorderAttributeHandler;
import song.jtslkj.tool.htmlspanner.handlers.attributes.StyleAttributeHandler;
...
public class HtmlSpanner {
     ...
     * @param handler handler 用于传送html代码中的img的url
     */
    public HtmlSpanner(Context context,int screenWidth,Handler handler) {
        this(context,createHtmlCleaner(), new SystemFontResolver(),screenWidth,handler);
    }
     ...
     * @param cleaner
     */
    public HtmlSpanner(Context context,HtmlCleaner cleaner, FontResolver fontResolver,int screenWidth,Handler handler) {
