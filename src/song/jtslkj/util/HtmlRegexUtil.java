...
public class HtmlRegexUtil {
	 ...
	 * @return
	 */
	public static String filterImgSrc(String htmlString) {
	...
	public static String filterEntityCharacter(String str) {
		str = new String(str);
		str = str.replaceAll("&nbsp;", " ");
		str = str.replaceAll("&lt;", "<");
		str = str.replaceAll("&gt;", ">");
