...
public class ToolBox {
     ...
     * @return
     **/
    public static String getSortFromSelect(String select) {

        if (select.trim().equals("排序")) {
            return "";
        } else if (select.trim().equals("开机优先")) {
            return "";
        } else if (select.trim().equals("关机优先")) {
            return "";
        } else if (select.trim().equals("异常优先")) {
            return "";
        } else {
            return select;
        }
     ...
     * @return
     **/
    public static String getVillageFromSelect(String select) {

        if (select.trim().equals("所有")) {
            return "";
        } else {
            return select;
        }
     ...
     * 1 表示开机
     */
    public static int getStateFromSelect(String select) {
     ...
     *
     * @param text 712^家佳源^公共^旅游基金^77.3^2015/7/6 20:23:15^^
     ...
     * 将时间的格式转化一下
     *
     * @param time 输入时间字符串 2015/7/10 10:16:53
     ...
     * 比较两个时间字符串的大小
     *
     * @param DATE1 日期格式固定 1995-11-12 15:21
     * @param DATE2 1997-11-12 15:21
     ...
     * 格式化输出月份,
     *
     * @param inputtime 2015-01-01 12:23:12 2015/01/01 12:23:12
     * @return 2015-01
     */
